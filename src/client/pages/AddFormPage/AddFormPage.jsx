	          ...
	          <div className="page__columns">
	            <div className="page__column">
	              <div className="msg-info">
	                ...
	                <p>
Если вы ещё не зарегистированы, можете сделать это за пару кликов с помощью кнопок социальных сетей или стандартным способом - заполнив
    <a className="form-text_link" href="/register">форму</a>
.
