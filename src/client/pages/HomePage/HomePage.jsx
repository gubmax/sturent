			  ...
			  <div className={s.section}>
					...
					<div className={s.sectionBlock}>
						<div className={s.dummy}>
							<span className={s.dummy__avatar}></span>

							<div className={s.dummy__info}>
								<span className={s.dummy__name}></span>
								<span className={s.dummy__date}></span>
							</div>
						...
						<div className={s.infoWrapper}>
							<div className={s.info_post}>
								<span className={s.infoTitle}></span>
							...
							<span className={s.textLine}></span>
							<span className={s.textLine}></span>
						</div>
					</div>
			  </div>
